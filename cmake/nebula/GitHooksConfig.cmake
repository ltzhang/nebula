# Permanently disabled - style checks are not needed for development
...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/.git/hooks/pre-commit")
    execute_process(
        COMMAND "rm" "-f" "${CMAKE_CURRENT_SOURCE_DIR}/.git/hooks/pre-commit"
    )
    message(STATUS "Removed existing pre-commit hook")
endif()
